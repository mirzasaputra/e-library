...
<head>
    ...
    <title>{{ $title }} | Administrator {{ getSetting('app_name') }}</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/daterangepicker/daterangepicker.min.css') }}">
    <!-- END: Vendor CSS-->
